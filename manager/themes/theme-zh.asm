...
.boot_menu_title                db  1,2,' ',3,4,' ',5,6,' ',7,8,0
.boot_menu_header               db  '    ',9,10,'  ',11,12,'  '
.boot_menu_header_noflags       db  '  ',14,15,'  ',16,17
.boot_menu_header_nonumber      db  '  ',18,19,'  ',20,21,' '
.boot_menu_header_notype        db  '  ',22,23,'  ',24,25,0
...
; about infomation.
.about_content     db '           Smart Boot Manager 3.90.1-zh',0x0d
...
.main_menu_bootit    db  1,2,'  ',3,4,0
.main_menu_bootprev  db  1,2,3,4,214,215,216,217,' MBR',0
.main_menu_quit      db  'Quit         ~Ctrl-Q~',0
.main_menu_poweroff  db  'Power Off  ~Ctrl-F12~',0
.main_menu_recordset db  1,2,3,4,150,151,152,153,196,197,198,199,'     ->',0
.main_menu_sysset    db  218,219,220,221,196,197,198,199,'         ->',0
.main_menu_save      db  192,193,'  ',194,195,'           ~F2~',0
.main_menu_bar       db  '-------------------',0

; record settings menu
.record_menu_title    db  1,2,3,4,150,151,152,153,196,197,198,199,0
.record_menu_info     db  128,129,'    ',130,131,'      ~/ or ?~',0
.record_menu_name     db  22,23,'    ',24,25,'          ~F3~',0
.record_menu_passwd   db  146,147,'    ',148,149,'          ~F9~',0
.record_menu_schedule db  158,159,'    ',160,161,'      ~Ctrl-S~',0
.record_menu_keys     db  162,163,'    ',164,165,'      ~Ctrl-K~',0
.record_menu_act      db  176,177,'    ',178,179,'          ~F4~',0
.record_menu_hide     db  180,181,'    ',182,183,'          ~F5~',0
.record_menu_autoact  db  174,175,3,4,176,177,178,179,'          ~F6~',0
.record_menu_autohide db  174,175,3,4,180,181,182,183,'          ~F7~',0
.record_menu_swapdrv  db  184,185,186,187,166,167,3,4,168,169,'    ~Ctrl-X~',0
.record_menu_del      db  210,211,'    ',212,213,'      ~Ctrl-D~',0
.record_menu_dup      db  222,223,'    ',224,225,'      ~Ctrl-P~',0
.record_menu_moveup   db  226,227,'    ',228,229,'      ~Ctrl-U~',0
.record_menu_movedown db  230,231,'    ',228,229,'      ~Ctrl-N~',0
.record_menu_bar      db  '--------------------',0

; system setting menu
.sys_menu_title       db  218,219,220,221,196,197,198,199,0
.sys_menu_rootpasswd  db  142,143,144,145,146,147,148,149,'                   ~F10~',0
.sys_menu_admin       db  142,143,144,145,232,233,234,235,'              ~Ctrl-F10~',0
.sys_menu_security    db  204,205,236,237,232,233,234,235,'               ~Alt-F10~',0
.sys_menu_setdef      db  196,197,198,199,238,239,240,241,150,151,152,153,'                ~F8~',0
.sys_menu_unsetdef    db  200,201,202,203,238,239,240,241,150,151,152,153,'          ~Shift-F8~',0
.sys_menu_delay       db  196,197,198,199,136,137,138,139,'                ~Ctrl-T~',0
.sys_menu_bmstyle     db  196,197,198,199,1,2,3,4,5,6,7,8,232,233,234,235,'        ~Ctrl-F~',0
.sys_menu_remlast     db  192,193,194,195,226,227,242,243,1,2,3,4,150,151,152,153,'        ~Ctrl-L~',0
...
.sys_menu_set_ioports db  196,197,198,199,' CD-ROM I/O Ports',0
.sys_menu_set_y2kfix  db  'Set year (fix Y2K BIOS bug)',0
.sys_menu_inst        db  204,205,206,207,' Smart BootManager',0
.sys_menu_uninst      db  210,211,212,213,' Smart BootManager',0
.sys_menu_bar         db  '------------------------------',0
