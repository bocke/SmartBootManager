...
.convert_failed:
        mov byte [hdio_tmp.disk_errno], 0xFE             ; invalid LBA address
        pop ax
        stc
        ret
...
disk_access:
	...
	push ebx
        ...
        push es
        push ds                         ; ds -> es, hdio_tmp.driveinfo is in ds segment.
        pop es
...
;==============================================================================
; get_last_disk_errno ---- get the last disk error number
; input:
;	none
; output:
;	ax = errno
